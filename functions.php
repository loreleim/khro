...
if ( ! function_exists( 'khro_setup' ) ) :
	...
	function khro_setup() {
		 ...
		 * If you're building a theme based on khro, use a find and replace
		 * to change 'khro' to the name of your theme in all the template files.
		 */
		...
		register_nav_menus(
			array(
				'menu-1' => esc_html__( 'Primary', 'khro' ),
			)
		);
 ...
 */
function khro_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'khro_content_width', 640 );
}
add_action( 'after_setup_theme', 'khro_content_width', 0 );
 ...
 */
function khro_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'khro' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'khro' ),
